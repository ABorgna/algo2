...
\algoritmo{maxNat}{
        ...
        \State $res \gets t.maxminNat.max$                          \comment \bigo(1)
}

\algoritmo{minNat}{
        \param{in}{$t$}{$tabla$}
        }{nat}{\bigo(1)}{
        \State $res \gets t.maxminNat.min$                          \comment \bigo(1)
}

\algoritmo{maxString}{
        \param{in}{$t$}{$tabla$}
        }{string}{\bigo(1)}{
        \State $res \gets t.maxminString.max$                       \comment \bigo(1)
}

\algoritmo{minString}{
        \param{in}{$t$}{$tabla$}
        }{string}{\bigo(1)}{
        \State $res \gets t.maxminString.min$                       \comment \bigo(1)
}
