...
\tadAxioma{joinRegistros(t, tRegistros, t', campo, sumaRegistros)}{
  ...
  ELSE
    {\IF
        ...
        \hspace*{3em} rValor(dameUno(tRegistros), campo)))
    THEN
        joinRegistros(t, sinUno(tRegistros), t', \\
        \hspace*{1em} Ag(unionRegistros(dameUno(tRegistros), \\
        \hspace*{3em} dameRegistro(t', campo, \\
        \hspace*{3em} rValor(dameUno(registros), campo))), \\
        \hspace*{3em} sumaRegistros \\
        \hspace*{1em} ) \\
        )
    ELSE
      joinRegistros(t, sinUno(tRegistros), \\
      \hspace*{6em} t', sumaRegistros)
    FI}
  FI}
