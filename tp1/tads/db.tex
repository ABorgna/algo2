...
\tadGeneros{database}
\tadExporta{database, generadores, observadores}
\tadUsa{?}
...
\tadOperacion{correrTriggers}{database/db, conj(nombreTrigger)/ntgs, nombreTabla/ntInsert, nombreTabla/ntTarget, registro/r}{tabla}{$\neg$(ntInsert = ntTarget)}
