...
\tadOperacion{sumaRegistros}{registro, registro}{registro}{}
\tadOperacion{sumaRegistrosAux}{registro, registro, conj(campo), conj(campo), registro}{registro}{}
\tadOperacion{tieneCampo}{registro, campo}{bool}{}
...
\tadAxioma{tieneCampo(r, c)}{
    c $\in$ rCampos(r))
}
\tadAxioma{sumaRegistros(r, r')}{
    sumaRegistrosAux(r, rCampos(r), r', rCampos(r'), nuevoRegistro)
}
\tadAxioma{sumaRegistrosAux(r, r', rCampos, r'Campos, nuevo)}{
    \IF ($\varnothing$?(rCampos) $\land$ $\varnothing$?(rCampos)) THEN
        nuevo
    ELSE
        {\IF $\neg$ $\varnothing$?(rCampos) THEN
            {\IF $\neg$ tieneCampo(dameUno(rCampos), nuevo) THEN
                sumaRegistrosAux(r, r', sinUno(rCampos), r'Campos,
                agregarValor(nuevo, dameUno(rCampos), rValor(r, dameUno(rCampos)))
            ELSE
                sumaRegistrosAux(r, r', sinUno(rCampos), r'Campos, nuevo)
            FI}
        ELSE
            {\IF $\neg$ tieneCampo(dameUno(r'Campos), nuevo) THEN
                sumaRegistrosAux(r, r', rCampos, sinUno(r'Campos),
                agregarValor(nuevo, dameUno(r'Campos), rValor(r, dameUno(r'Campos)))
            ELSE
                sumaRegistrosAux(r, r', rCampos, sinUno(r'Campos), nuevo)
            FI}
        FI}
    FI}
